...
psql -U $DB_USER $DB_NAME -F "," --no-align -c "TRUNCATE lots_lot CASCADE; TRUNCATE lots_lotgroup CASCADE; TRUNCATE owners_owner CASCADE; TRUNCATE owners_ownercontact CASCADE; TRUNCATE steward_stewardproject CASCADE; TRUNCATE lots_lotlayer CASCADE; TRUNCATE notes_note CASCADE; TRUNCATE organize_organizer CASCADE; TRUNCATE livinglots_lots_use CASCADE; TRUNCATE photos_photo CASCADE;" 
